...
const FILES = [
  ...
  "./pages/authorize/bindmobile.wxss",
  "./pages/authorize/index.wxss",
  "./pages/category/category.wxss",
  "./pages/coupons/index.wxss",
  "./pages/deposit/pay.wxss",
  "./pages/fx/apply-status.wxss",
  "./pages/fx/apply.wxss",
  "./pages/fx/commisionLog.wxss",
  "./pages/fx/members.wxss",
  "./pages/goods-details/index.wxss",
  "./pages/goods-details/poster.wxss",
  "./pages/index/index.wxss",
  "./pages/invoice/apply.wxss",
  "./pages/invoice/list.wxss",
  "./pages/kanjia/index.wxss",
  ...
  "./pages/score-excharge/index.wxss",
  "./pages/select-address/index.wxss",
  "./pages/shop-cart/index.wxss",
  "./pages/sign/index.wxss",
  "./pages/start/start.wxss",
  "./pages/template-cart/template-cart.wxss",
  "./pages/to-pay-order/index.wxss",
  "./pages/withdraw/index.wxss",
  "./pages/wuliu/index.wxss",
  "./template/calendar/index.wxss",
  "./template/datepicker/index.wxss",
  "./weui/base/fn.wxss",
  ...
  "./weui/widget/weui-cell/weui-form.wxss",
  ...
  "./weui/widget/weui-loading/weui-loading.wxss",
...
export const testSuit: ITestSuit = {
  compilerConfig: {
    FILES,
    FILESBASE: path.join(__dirname, "./wechat-app-mall"),
